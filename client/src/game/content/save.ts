...
export const LEGACY_PRESENTATION_SETTINGS_KEY =
  'gym-buddies.presentation.settings.v1';
export const SAVE_EXPORT_FORMAT = 'gym-buddies-save' as const;
export const SAVE_IMPORT_MAX_BYTES = 1_048_576;
